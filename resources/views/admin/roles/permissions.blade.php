              ...
              @if(!empty($permissions))
                ...
                <div class="top-permission col-md-12">
                  ...
                  <div class="sub-permissions col-md-11 col-md-offset-1">
                    <div class="col-sm-3">
                    @foreac($permission['son'] as $sub))
                      <label><input type="checkbox" name="permissions[]"
                                    value="{{$sub['id']}}"
                                    class="sub-permission-checkbox" @if(in_array($sub['id'],$p_ids)) checked @endif/>&nbsp;&nbsp;<span
                              class="fa fa-bars"></span>{{$ub['name']}}
                      </label>
                     @endforeach
                 <!--    <label><input type="checkbox" name="permissions[]"
                                  value=""

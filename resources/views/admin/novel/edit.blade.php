	...
	<div class="alert alert-danger">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="{{route('admin.novel.doEdit')}}" method="post">
            {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
              <div class="radio"><label for=""><input type="radio" name="status" value="1" {{$novel->status == 1 ? 'checked' :''}}>连载</label></div>
              <div class="radio"><label for=""><input type="radio" name="status" value="2" {{$novel->status == 2 ? 'checked' :''}}>完结</label></div>
              </div>
            </div> 
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
              <textarea name="desc" id="container" cols="30" rows="10">{{$novel->desc}}</textarea>
              </div>
            </div> 

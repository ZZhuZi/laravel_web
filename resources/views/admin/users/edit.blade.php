        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="{{route('admin.user.doEdit')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="file" placeholder=" 用户头像" class="form-control" name="image_url" /><img src="{{$user->image_url}}" style="width :50px;" alt="">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
              <div class="radio"><label for=""><input type="radio" name="is_super" value="1" @if($user->is_super == 1) checked @endif> 否</label></div>
              <div class="radio"><label for=""><input type="radio" name="is_super" value="2" @if($user->is_super == 2)  @endif> 是</label></div>
              </div>
            </div>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-6">
              <div class="radio"><label for=""><input type="radio" name="status" value="1" @if($user->is_super == 1) checked @endif> 正常</label></div>
              <div class="radio"><label for=""><input type="radio" name="status" value="2" @if($user->is_super == 2)  @endif> 禁用</label></div>
              </div>
            </div>
